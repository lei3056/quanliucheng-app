...
export default function Home1({ onNavigate, onTrack, onShowList }: { onNavigate?: (tab: 'home' | 'home1' | 'study' | 'schedule' | 'schedule1' | 'profile' | 'profile1' | 'favorites' | 'targeted' | 'jobListing') => void; onTrack?: (title: string, status: any) => void; onShowList?: (title: string) => void }) {
  ...
  const focusedItems = [
    ...
    { unit: '杭州市余杭区政府', position: '综合管理储备干部', location: '杭州', edu: '硕士', special: '无限制', deadline: '截止: 04-10', status: '已结束', statusColor: 'slate', type: '公务员', color: 'primary' },
    { unit: '绵阳经济技术开发区三江小学', position: '小学语文教师', location: '绵阳', edu: '本科', special: '无限制', deadline: '发布: 04-27', status: '报名未开始', statusColor: 'primary', type: '事业编', color: 'teal' },
    ...
    { unit: '成都市某区税务局', position: '税务专员', location: '成都', edu: '本科', special: '应届生', deadline: '截止: 05-20', status: '报名未开始', statusColor: 'primary', type: '公务员', color: 'primary' },
    ...
    { unit: '上海市人民法院', position: '法官助理', location: '上海', edu: '硕士', special: '需法考A证', deadline: '截止: 05-05', status: '进行中', statusColor: 'emerald', type: '公务员', color: 'primary' },
    { unit: '北京市东城区教委', position: '行政管理', location: '北京', edu: '本科', special: '京籍', deadline: '截止: 05-18', status: '报名未开始', statusColor: 'primary', type: '事业编', color: 'teal' },
  ...
  const favoritesItems = [
    ...
    { unit: '杭州某知名研究机构', position: '研究员助理', location: '杭州', edu: '硕士', special: '合同制', deadline: '截止: 05-30', status: '报名未开始', statusColor: 'primary', isHot: false },
            ...
            <div>
              ...
              <div className="bg-white rounded-[10px] mx-4 overflow-hidden mb-6 shadow-sm border border-slate-200/40">
                {[
                  ...
                  { name: '国企招聘', count: 188, icon: '国', bg: '#10b981' },
