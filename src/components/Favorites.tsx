      ...
      <div className="flex-1 overflow-y-auto px-6 py-6 flex flex-col gap-4 pb-32">
        ...
        <div className="bg-white p-5 rounded-2xl shadow-sm border border-slate-200 relative overflow-hidden">
          ...
          <div className="flex justify-between items-start">
            ...
            <button className="text-primary-600 bg-primary-50 p-2 rounded-lg border border-primary-100">
              <Bookmark size={14} className="fill-current" />
            </button>
          </div>
          <div className="flex gap-2 mb-4">
             <span className="text-[10px] font-bold uppercase tracking-wider text-slate-500 bg-slate-50 border border-slate-100 px-2 py-1 rounded-md flex items-center gap-1"><MapPin size={10}/> 成都</span>
        ...
        {/* Item 2 */}
        <div className="bg-white p-5 rounded-2xl shadow-sm border border-slate-200 relative overflow-hidden opacity-75">
          ...
          <div className="flex justify-between items-start">
            ...
            <button className="text-slate-400 bg-slate-50 p-2 rounded-lg border border-slate-200">
              <Bookmark size={14} className="fill-current" />
            </button>
          </div>
          <div className="flex gap-2 mb-4">
